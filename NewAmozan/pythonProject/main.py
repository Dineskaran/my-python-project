...
def main():
    ...
    if choice == "create Account":
        ...
        if selected_account:
            ...
            services = st.selectbox(f"Select services:", ["Deposit", "withdraw", "check Balance"])
            ...
            if services == "Deposit":
                ...
                withdraw_amount = st.number_input("enter your withdraw amount")
